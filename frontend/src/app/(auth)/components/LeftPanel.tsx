  ...
  return (
    <>
      <div className="absolute inset-0 opacity-10">
        <div className="bg-accent-500 absolute top-0 left-0 h-96 w-96 rounded-full blur-3xl"></div>
        <div className="bg-accent-500 absolute right-0 bottom-0 h-96 w-96 rounded-full blur-3xl"></div>
      </div>

      <div className="relative z-10">
        <div className="mb-8 flex items-center space-x-3">
          <TrendingUp className="hover:text-accent-500 h-10 w-10" />
