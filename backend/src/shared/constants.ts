...
export const ADMIN_DASHBOARD_PERFORMANCE_POINTS = 6;
export const ADMIN_DASHBOARD_PERFORMANCE_INTERVAL_HOURS = 4;
export const ADMIN_DASHBOARD_PERFORMANCE_REQUEST_BASE = 120;
export const ADMIN_DASHBOARD_PERFORMANCE_REQUEST_STEP = 55;
export const ADMIN_DASHBOARD_PERFORMANCE_ACCURACY_BASE = 82;
export const ADMIN_DASHBOARD_PERFORMANCE_ACCURACY_STEP = 2;
export const ADMIN_DASHBOARD_PERFORMANCE_MIN_LOAD = 10;
export const ADMIN_DASHBOARD_PERFORMANCE_LOAD_STEP = 3;
export const ADMIN_DASHBOARD_PERFORMANCE_LOAD_OFFSET = 5;
export const ADMIN_DASHBOARD_MAX_ACTIVITIES = 5;
export const ADMIN_DASHBOARD_RECENT_USERS_LIMIT = 3;
